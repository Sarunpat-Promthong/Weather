...
<head>
    ...
    <style>
        .background-area{
            background-color :rgb(101, 78, 202);
...
<script>
    ...
    function setDefault(){
        var urlDefualt = "https://api.openweathermap.org/data/2.5/weather?lat=7.8433946&lon=99.189273&appid=5357a64214e14da618d37ba0456770cd";
        $.getJSON(urlDefualt)
            .done((data) => {
                ...
                var line = "<div id='dataWeather'>";
                    line += "<img src='https://thailandtourismdirectory.go.th/assets/upload/2020/07/13/202007134ceec6ffcbf5790e27b01f54606be7a0140407.jpg' class='card-img-top' ><div class='card-body'>"
    ...
    function LoadForcast() {
        var x = $("#Latitude").val();
        var y = $("#Longitude").val();
        var url = "https://api.openweathermap.org/data/2.5/weather?lat=" + x + "&lon=" + y + "&appid=5357a64214e14da618d37ba0456770cd"       
        $.getJSON(url)
            .done((data) => {
                var datetime = convertHMS(data.dt);
                var sunrise = convertHMS(data.sys["sunrise"]);
